        ...
        <div className="text-foreground">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp}>
                ...
                <p className="text-sm md:text-base text-muted-foreground font-medium mb-12 leading-relaxed">
                    Welcome to Campus Hive, a centralized C2C e-commerce platform designed for the exchange of goods and services within university communities.
                </p>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp} className="mb-12">
                ...
                <div className="text-sm text-muted-foreground space-y-4">
                    <p>
                        These Terms of Use ("Terms," "Agreement," "Policies") constitute a legally binding agreement between you ("User," "you," "your") and Campus Hive ("Platform," "we," "us," "our") governing your access to and use of the Campus Hive website, mobile applications, and related services (collectively, the "Services").
                    </p>
                    <p className="font-bold text-foreground">
                        By registering for, accessing, or using Campus Hive, you acknowledge that you have read, understood, and agree to be bound by these Terms. If you do not agree to these Terms, you may not access or use the Services.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp} className="mb-12">
                ...
                <div className="text-sm text-muted-foreground space-y-4">
                    <p>
                        You agree to provide accurate, current, and complete information during registration. You are solely responsible for maintaining the confidentiality of your credentials and all activities that occur under your account. Campus Hive reserves the right to terminate accounts for severe or repeated policy violations, illegal activity, fraud or scams, harassment or threats, impersonation, or unauthorized commercial solicitation.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp} className="mb-12">
                ...
                <div className="text-sm text-muted-foreground space-y-4">
                    <p>
                        <strong className="text-foreground">Campus Hive is an intermediary platform</strong> that facilitates connections between buyers and sellers. We are not a party to any transaction. We do not guarantee the quality, safety, or legality of items, the truth or accuracy of listings, or the ability of users to complete transactions.
                    </p>
                    <div className="bg-secondary/30 p-5 rounded-2xl italic border border-border mt-4">
                        "THE PLATFORM IS PROVIDED 'AS IS' AND 'AS AVAILABLE' WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE MAXIMUM EXTENT PERMITTED BY LAW, CAMPUS HIVE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES."
                    </div>
                </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp} className="mb-12">
                ...
                <div className="text-sm text-muted-foreground space-y-4">
                    <p>
                        Campus Hive, including all code, design, logos, trademarks, and original content, is owned by Campus Hive and protected by intellectual property laws. You retain ownership of content you create and post on Campus Hive, but you grant Campus Hive a worldwide, royalty-free, perpetual license to host, store, and display the content.
                    </p>
                </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp}>
                ...
                <div className="text-sm text-muted-foreground space-y-4">
                    <p>
                        These Terms shall be governed by and construed in accordance with the laws of the Federal Republic of Nigeria. Before initiating any formal proceeding, you agree to attempt informal resolution by contacting <a href="mailto:[EMAIL_ADDRESS]" className="text-primary hover:underline">[EMAIL_ADDRESS]</a>. Any unresolved dispute shall be resolved by binding arbitration in accordance with the Arbitration and Conciliation Act, Cap A18, Laws of the Federation of Nigeria, 2004, taking place in Zaria, Kaduna State.
                    </p>
                    <p className="font-bold text-foreground mt-4">
                        YOU AND CAMPUS HIVE AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.
                    </p>
                </div>
            </motion.div>
        </div>
