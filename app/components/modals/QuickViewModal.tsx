                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-border" data-lenis-prevent>
                            ...
                            <div className="px-5 pt-2 pb-5 space-y-4">
                                ...
                                <div className="flex justify-between items-start gap-3">
                                    <h2 className="text-base font-bold font-heading tracking-tight leading-tight flex-1 text-foreground">
                                        {product.title}
                                    </h2>
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                    <div className="flex items-center gap-1.5 text-[9px] font-bold uppercase tracking-widest text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg border border-emerald-100 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-900/50">
                                        <svg className="w-3 h-3 fill-current" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                        </svg>
                                        <span>{product.recommendedCount} Recommended</span>
                                    </div>
                                    <div className="flex items-center gap-1 text-[9px] font-bold uppercase tracking-widest text-white bg-[#1D9BF0] px-1 py-1 rounded-full border border-[#1D9BF0] shadow-sm">
                                        <BadgeCheck className="w-4 h-4" fill="#1D9BF0" stroke="white" strokeWidth={2} />
                                    </div>
                                    <div className="flex items-center gap-1 text-[9px] font-bold uppercase tracking-widest text-foreground bg-secondary/80 px-2.5 py-1 rounded-lg border border-border/50">
                                ...
                                <div className="space-y-2 bg-secondary/40 p-4 rounded-2xl border border-border/40">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground">Overview</span>
                                    </div>
                                ...
                                <div className="flex items-center gap-3 p-3 bg-card border border-border rounded-2xl hover:border-primary/40 hover:shadow-sm transition-all cursor-pointer">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-bold text-foreground truncate">{product.seller || "Student Seller"}</p>
                                        <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground">Verified Campus Vendor</p>
                                    </div>
                                    <button className="h-8 px-3 rounded-xl bg-foreground text-background text-[9px] font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-all shadow-sm active:scale-95">
                                        Profile
                                    </button>
                                </div>
                        ...
                        <div className="p-3 border-t border-border/50 bg-card flex gap-2 shadow-[0_-8px_40px_rgba(0,0,0,0.04)]">
                            <button
                                ...
                                className="flex-1 h-11 rounded-xl font-bold uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 bg-primary text-white hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-primary/40 transition-all group"
                            >
