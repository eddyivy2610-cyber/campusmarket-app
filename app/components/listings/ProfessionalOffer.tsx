    ...
    if (!offer) {
        return (
            <div className="bg-secondary/10 border border-border/40 rounded-2xl overflow-hidden shadow-sm p-4 text-center">
                <span className="font-bold text-[11px] uppercase tracking-widest text-muted-foreground/70">
            ...
            <div className="px-5 py-4 space-y-3.5">
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="font-bold text-[11px] uppercase tracking-widest text-primary leading-tight">
                            THIS USER IS CURRENTLY RUNNING A PROMOTION FOR THIS ITEM
                        </span>
                    </div>
                    <div className="px-2 py-0.5 bg-primary/10 rounded-full text-[8px] font-bold text-primary uppercase tracking-widest border border-primary/10 shrink-0 mt-1">
                        Active
                    </div>
                </div>
                <div className="space-y-2.5">
                    <div className="flex items-center justify-between p-3 bg-primary text-white rounded-xl shadow-lg shadow-primary/20">
                        <div className="space-y-0.5">
                            <p className="text-[8px] font-bold text-white/60 uppercase tracking-[0.15em]">Promo Condition</p>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-white dark:bg-zinc-900/50 rounded-xl border border-primary/10">
                        ...
                        <div className="space-y-0.5">
                            <p className="text-[8px] font-bold text-muted-foreground uppercase tracking-[0.15em]">Valid Until</p>
