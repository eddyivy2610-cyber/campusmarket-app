...
const ACTIONS = [
    ...
    },
    {
        ...
        icon: Store,
        tone: "border-[#efe3cf] text-[#1f1f1f] bg-white dark:border-border/70 dark:text-foreground dark:bg-[#202642]",
    },
    {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="min-w-0">
                                    <span className="block text-[11px] font-heading font-medium text-black dark:text-foreground">
                                        {action.title}
                                    </span>
                                </span>
                            </button>
