                    ...
                    {visibleCategories.map((cat, idx) => {
                        ...
                        return (
                            <Link
                                ...
                                className="flex items-center justify-between px-2.5 py-2 rounded-xl border border-transparent bg-white dark:bg-transparent transition-all duration-200 group hover:border-[#FFD700]/40 hover:bg-[#fff9e6] dark:hover:bg-white/10"
                            >
                                <div className="flex items-center gap-2 text-[11px] font-heading font-medium text-black dark:text-foreground group-hover:text-black dark:group-hover:text-foreground">
                                    <span className="w-6 h-6 rounded-md bg-[#fff3c6] dark:bg-white/10 text-[#FFD700] flex items-center justify-center transition-colors group-hover:bg-[#FFD700] group-hover:text-black">
