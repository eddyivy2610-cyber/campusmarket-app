...
const DISCOVER_PROFILES: DiscoverProfile[] = [
    {
        ...
        category: "Custom furniture & woodworking",
        rating: 4.7,
        description: "",
        color: "bg-blue-500",
    },
    {
        id: "2",
        name: "Gems & Jewelry",
        category: "Handcrafted fine jewelry designs",
        rating: 5.0,
        description: "",
    ...
    },
    {
        ...
        category: "Homemade organic food products",
        rating: 4.2,
        description: "",
    ...
    },
    {
        ...
        category: "Innovative tech products & accessories",
        rating: 4.6,
        description: "",
        color: "bg-amber-500",
    },
        ...
        <section className="py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {DISCOVER_PROFILES.map((profile) => (
                    <div key={profile.id} className="bg-card border border-border/40 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col">
                        {/* Color Header */}
                        ...
                        <div className="px-6 pb-6 pt-0 flex-1 flex flex-col items-center -mt-10">
                            ...
                            <button className="mt-auto w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-2.5 rounded-full transition-colors text-sm">
                                View Profile
                            </button>
                        </div>
                    </div>
